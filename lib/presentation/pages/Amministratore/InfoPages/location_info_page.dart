...
@RoutePage()
class LocationInfoAdminPage extends StatefulWidget {
  const LocationInfoAdminPage({super.key, required this.location});

  final Location location;

  @override
  State<LocationInfoAdminPage> createState() => _LocationInfoAdminPageState();
}

class _LocationInfoAdminPageState extends State<LocationInfoAdminPage> {
  @override
